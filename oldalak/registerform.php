...
<form class="form bg-transparentblack text-light p-4 mt-4" action="actions/registeraction.php" method="post" target='kisablak'>
    ...
    <div class="mb-3" id="password-container">
        <label for="InputPassword" class="form-label">Jelszó megerősítése</label>
    ...
    <div class="mb-3">
        <label for="InputCaptcha" class="form-label">Számítsa ki az eredményt: <?php echo "$szam1 + $szam2 = "; ?></label>
    ...
    <a href="#error-message"><button type="submit" class="btn btn-warning w-100">Regisztrálok</button></a>
