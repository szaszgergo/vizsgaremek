<div class="form-container">
    <form method="post" action="actions/uzenofal_feldolgozas.php" target="kisablak" enctype="multipart/form-data">
        ...
        <label for="title"><h3>Cím:</h3></label> <br>
        <textarea id="title" class="form-textarea" name="cim" required></textarea> <br><br>
        <label for="content"><h3>Szöveg:</h3></label> <br>
