<footer class="footer">
    <div class="text p-3">
        <!-- Adatvédelmi hivatkozás -->
        <p><a class="text-warning" href="./?o=adatvedelem"><?= $languageContent['adatvedelmi'] ?></a></p>
        ...
        <!-- Copyright -->
        <p class="text-white" style="font-size: small;"><?= $languageContent['copyright'] ?></p>
    </div>
</footer>
