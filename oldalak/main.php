    ...
    <section>
        <div class="row" style="text-align:center;">
            ...
            <div class="mb-5">
                ...
                <button onclick='window.top.location.href = "./?o=jegyvasarlasform";' class="btn btn-dark">bruh</button>
            </div>
        </div>
    </section>
    <section>
        <div class="row mb-5">
        <h1>Miért Edz nálunk?</h1>
    ...
    <section>
        <div class="row mb-5">
                <div class="col-md-6" style="text-align:left;">
                        ...
                        <p>Budapest, Mária királyné útja 18, 1213</p>
